Public Class MainForm
    ...
    Public Shared SessionRole As String = "Admin"
    ...
    Private Sub UpdateStatus()
        If LoggedIn Then
            ...
            lblWelcomeSub.Text = "Hotel Receptionist System  ·  " & DateTime.Now.ToString("dddd, dd MMMM yyyy")
        Else
            lblStatusUser.Text = "User: -"
        End If
    End Sub

    ' ── Kembali ke dashboard kalau semua child ditutup ────
